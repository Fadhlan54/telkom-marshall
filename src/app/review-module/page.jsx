      ...
      <ContentLayout>
        ...
        <div className="flex  sm:justify-end text-xs gap-2 mb-2">
          <Link
            ...
            className="py-1 px-6 bg-primary-1 text-white rounded-full"
          >
        ...
        <div className="overflow-x-auto shadow-lg ">
          <table className="w-full text-left rtl:text-right text-gray-500 border-separate border-spacing-0 text-xs">
            <thead className="  uppercase bg-primary-1 text-white text-center">
              <tr>
                <th
                  scope="col"
                  className="px-3 py-2 border border-r-0 border-secondary-1 rounded-l-lg font-semibold w-10 whitespace-nowrap"
                >
                  No
                </th>
                <th
                  scope="col"
                  className="px-3 py-2 border border-r-0 border-secondary-1 font-semibold"
                >
                  EYD
                </th>
                <th
                  scope="col"
                  className="px-3 py-2 border border-r-0 border-secondary-1 font-semibold min-w-36"
                >
                  Clarity
                </th>
                <th
                  scope="col"
                  className="px-3 py-2 border border-r-0 border-secondary-1 font-semibold min-w-[8rem]"
                >
                  Content
                </th>
                <th
                  scope="col"
                  className="px-3 py-2 text-center border border-secondary-1 rounded-r-lg font-semibold"
                >
                  Approvement
                </th>
              </tr>
